...
class GuideTest {
    ...
    fun testKotlinxCoroutinesGuideBasic05() {
        test("KotlinxCoroutinesGuideBasic05") { kotlinx.coroutines.guide.basic05.main(emptyArray()) }.also { lines ->
    ...
    fun testKotlinxCoroutinesGuideBasic06() {
        test("KotlinxCoroutinesGuideBasic06") { kotlinx.coroutines.guide.basic06.main(emptyArray()) }.verifyLines(
            "I'm sleeping 0 ...",
            "I'm sleeping 1 ...",
            "I'm sleeping 2 ..."
        )
    ...
    fun testKotlinxCoroutinesGuideContext08() {
        test("KotlinxCoroutinesGuideContext08") { kotlinx.coroutines.guide.context08.main(emptyArray()) }.verifyLines(
